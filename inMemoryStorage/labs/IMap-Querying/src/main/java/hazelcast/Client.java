...
public class Client {
    ...
    public static void main(String[] args) {
         ...
         * SQL Predicate
         */
        SqlPredicate sqlPred = new SqlPredicate("salary between 0 and 2000");

        /**
         * Boolean predicate
         */
        PredicateBuilder.EntryObject entry = Predicates.newPredicateBuilder().getEntryObject();
        Predicate boolPred = entry.get("salary").between(0, 2000);

        // Either predicate here should return same result
        Collection<Employee> matches = map.values(boolPred);
